  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-50 via-white to-slate-50" id="travel-plans">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="relative mt-20 sm:mt-32 px-4">
          {/* Split Design */}
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-green-600 font-semibold text-xs sm:text-sm uppercase tracking-wide">Live Support</span>
                  </div>
                </div>

                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
                  Still Confused About <br className="hidden sm:block" />
              ...
              <div className="lg:pl-8 mt-8 lg:mt-0">
                <div className="relative">
                  {/* Main CTA Card */}
                  <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border-2 border-gray-100 hover:shadow-2xl transition-all duration-300">
                    <div className="text-center space-y-4 sm:space-y-6">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-green-400 to-green-600 rounded-2xl mx-auto mb-3 sm:mb-4 flex items-center justify-center transform rotate-3 hover:rotate-0 transition-transform duration-300">
                        <WhatsAppIcon className="w-8 h-8 sm:w-10 sm:h-10" fill="white" />
                      </div>
                      
                      <div>
                        <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Chat with Expert</h4>
                        <p className="text-gray-600 text-sm">Get personalized recommendations in minutes</p>
                      </div>

                      <button
                        onClick={() => handleWhatsAppContact()}
                        className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2"
                      >
                        <span className="text-sm sm:text-base">Start Free Consultation</span>
                  ...
                  {/* Floating elements */}
                  <div className="absolute -top-2 sm:-top-3 -right-2 sm:-right-3 w-4 h-4 sm:w-6 sm:h-6 bg-orange-400 rounded-full opacity-80"></div>
                  <div className="absolute -bottom-2 sm:-bottom-3 -left-2 sm:-left-3 w-3 h-3 sm:w-4 sm:h-4 bg-blue-400 rounded-full opacity-60"></div>
                </div>
              </div>
            </div>
          </div>
