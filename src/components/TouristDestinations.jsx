        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto p-4 sm:p-8 md:p-12">
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 rounded-2xl p-4 sm:p-6 md:p-8 border border-emerald-400/30 mb-8">
                <h4 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  Want to Explore Beyond These?
                </h4>
                <p className="text-gray-300 text-base sm:text-lg mb-6 px-2 sm:px-4">
                ...
                <button
                  ...
                  className="group w-full sm:w-auto flex sm:inline-flex items-center justify-center space-x-2 sm:space-x-3 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-xl sm:rounded-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-2xl hover:shadow-emerald-500/25 text-sm sm:text-base"
                >
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 group-hover:rotate-12 transition-transform flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="truncate">Discover All Destinations</span>
                </button>
              </div>
